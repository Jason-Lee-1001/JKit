...
fun Activity.hideKeyboard() {
    var currentFocusView = window.currentFocus
    currentFocusView.isNull({
        val decorView = window.decorView
        decorView.findViewWithTag<View>("keyboardFocusView").isNull({
    ...
    currentFocusView?.let { hideKeyboard(it) }
}
